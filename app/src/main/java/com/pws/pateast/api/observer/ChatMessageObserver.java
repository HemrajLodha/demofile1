...
/**
 * Created by intel on 21-Sep-17.
 */

public abstract class ChatMessageObserver<T extends Cursor> extends DisposableSingleObserver<T> {
    ...
    public void onSuccess(T value) {
        ...
        if (value != null && value.getCount() != 0) {
            ...
            onError(new RetrofitException(getMessage(), RetrofitException.ERROR_TYPE_MESSAGE));
        }
    }
