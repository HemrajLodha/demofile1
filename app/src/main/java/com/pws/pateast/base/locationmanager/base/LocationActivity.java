package com.pws.pateast.base.locationmanager.base;
...
public abstract class LocationActivity extends ResponseAppActivity implements LocationListener {
    ...
    protected boolean canTrackWhenLightOff() {
        // override if needed
        return false;
    }
}
