package com.pws.pateast.base.locationmanager.configuration;

import android.support.annotation.NonNull;

import com.google.android.gms.location.LocationRequest;
import com.pws.pateast.base.locationmanager.listener.LocationListener;

import static com.pws.pateast.base.locationmanager.LocationView.LOCATION_DISPLACEMENT;
import static com.pws.pateast.base.locationmanager.LocationView.LOCATION_FASTEST_INTERVAL;
import static com.pws.pateast.base.locationmanager.LocationView.LOCATION_INTERVAL;
import static com.pws.pateast.base.locationmanager.LocationView.LOCATION_PRIORITY;
...
public final class Configurations {
     ...
     */
    public static LocationConfiguration defaultConfiguration(boolean keepTracking, @NonNull String rationalMessage, @NonNull String gpsMessage) {
        return new LocationConfiguration.Builder()
                .keepTracking(keepTracking)
    ...
    public static LocationConfiguration getConfiguration(boolean keepTracking, @NonNull String rationalMessage, @NonNull String gpsMessage) {
        return new LocationConfiguration.Builder()
                .keepTracking(keepTracking)
                .askForPermission(new PermissionConfiguration.Builder().rationaleMessage(rationalMessage).build())
                .useGooglePlayServices(new GooglePlayServicesConfiguration.Builder()
                        .locationRequest(Defaults.createLocationRequest(LOCATION_PRIORITY, LOCATION_INTERVAL, LOCATION_FASTEST_INTERVAL, LOCATION_DISPLACEMENT))
                        .build())
                .useDefaultProviders(new DefaultProviderConfiguration.Builder()
                        .requiredTimeInterval(LOCATION_INTERVAL)
                        .gpsMessage(gpsMessage)
                        .build())
                .build();
    }
