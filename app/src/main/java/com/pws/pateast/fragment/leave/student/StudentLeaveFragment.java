...
public class StudentLeaveFragment extends AppFragment implements StudentLeaveView, BaseRecyclerAdapter.OnItemClickListener, XRecyclerView.LoadingListener {
    private BaseRecyclerView rvLeave;
    private StudentLeavePresenter leavePresenter;
    ...
    protected void onViewReady(@Nullable Bundle savedInstanceState) {
        ...
        leavePresenter = new StudentLeavePresenter();
    ...
    public void leaveApply() {
        ...
        bundle.putSerializable(TaskActivity.EXTRA_TASK_TYPE, TaskType.STUDENT_LEAVE_APPLY);
        getAppListener().openActivityForResult(StudentTaskActivity.class, bundle, ADD_REQUEST);
    }
    ...
    public void setLeaveAdapter(List<Leave> leaves) {
        if (rvLeave.getAdapter() == null) {
            ...
            leaveAdapter.setUserType(UserType.STUDENT);
    ...
    public void onRefresh() {
        ...
        if (leavePresenter != null) {
            page = 1;
            leavePresenter.getStudentLeave();
        }
    }
            ...
            case R.id.tv_options:
                DialogUtils.showDialog(getContext(), R.string.app_name, R.string.cancel_prompt_message, new AdapterListener<String>() {
                    ...
                    public void onClick(int id, String value) {
                        switch (id) {
                            case 0:
                                leavePresenter.cancelStudentLeave(leave.getId());
                                break;
                        }
                    }
