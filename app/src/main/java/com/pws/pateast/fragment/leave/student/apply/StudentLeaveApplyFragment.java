...
public class StudentLeaveApplyFragment extends AppFragment implements StudentLeaveApplyView, OnDateChangeListener, View.OnClickListener {
    ...
    private StudentLeaveApplyPresenter mPresenter;
    ...
    protected void onViewReady(@Nullable Bundle savedInstanceState) {
        ...
        btnSubmit.setBackgroundColor(ContextCompat.getColor(getContext(), R.color.colorPrimaryStudent));

        etStartDate.setManager(getFragmentManager(), this);
        etEndDate.setManager(getFragmentManager(), this);
        etStartDate.setThemeId(R.style.DatePickerThemeStudent);
        etEndDate.setThemeId(R.style.DatePickerThemeStudent);
        ...
        mPresenter = new StudentLeaveApplyPresenter();
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.btn_submit:
                mPresenter.studentLeaveApply(reasonTag, typeTag, timeTag, etStartDate.getDateString(SERVER_DATE_TEMPLATE), etEndDate.getDateString(SERVER_DATE_TEMPLATE), etReasonOther.getText().toString());
                break;
            case R.id.tv_duration:
                if (popUpType != null)
                    popUpType.show();
