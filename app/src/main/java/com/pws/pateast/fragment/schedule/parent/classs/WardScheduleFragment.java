...
import com.pws.pateast.fragment.schedule.student.classs.StudentSchedulePresenter;
...
public class WardScheduleFragment extends AppFragment implements WardScheduleView {
    private BaseRecyclerView rvSchedule;
    private WardSchedulePresenter schedulePresenter;
    ...
    protected void onViewReady(@Nullable Bundle savedInstanceState) {
        ...
        schedulePresenter = new WardSchedulePresenter();
    ...
    public void setScheduleAdapter(List<Object> schedules) {
        if (rvSchedule.getAdapter() == null) {
            ...
            scheduleAdapter.setUserType(UserType.PARENT);
