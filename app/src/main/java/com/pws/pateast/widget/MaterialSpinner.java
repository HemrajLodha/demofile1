...
import com.pws.pateast.listener.OnSpinnerItemSelectedListener;
...
public class MaterialSpinner extends AppCompatSpinner implements ValueAnimator.AnimatorUpdateListener, AdapterView.OnItemSelectedListener {
    ...
    */
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        setBackgroundResource(R.drawable.m_spinner_background);
        setPaddingSafe(innerPaddingLeft, innerPaddingTop, 0, innerPaddingBottom);
    ...
    */
    ...
    public void setOnSpinnerItemSelectedListener(final OnSpinnerItemSelectedListener spinnerItemSelectedListener) {
    ...
    public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
        ...
        if (this.spinnerItemSelectedListener != null) {
            position = hint != null ? position - 1 : position;
            this.spinnerItemSelectedListener.onItemSelected(this, parent, view, position, id);
        }
    }
    ...
    public void onNothingSelected(AdapterView<?> parent) {
        if (this.spinnerItemSelectedListener != null) {
            this.spinnerItemSelectedListener.onNothingSelected(parent);
        }
    }
