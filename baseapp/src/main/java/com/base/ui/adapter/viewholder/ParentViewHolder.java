 ...
 * @since 5/27/2015
 */
public abstract class ParentViewHolder<P extends Parent<C, CF>, C, CF> extends RecyclerView.ViewHolder implements View.OnClickListener {
    @Nullable
    ...
    private BaseExpandableRecyclerAdapter.OnParentClickListener onParentClickListener;
    ...
    /**
     * Empowers {@link com.base.ui.adapter.BaseExpandableRecyclerAdapter}
    ...
    public abstract void bind(P mParent);
    ...
    public ParentViewHolder(@NonNull View itemView, BaseExpandableRecyclerAdapter.OnParentClickListener onParentClickListener) {
        super(itemView);
     ...
     * {@link com.base.ui.adapter.BaseExpandableRecyclerAdapter}.
     *
    ...
    public void onClick(View v) {
        if (onParentClickListener != null) {
            onParentClickListener.onParentClick(v, mParent, getParentAdapterPosition());
        }
