...
import static com.pws.calender.CompactCalendarView.CompactCalendarViewListener;
import static com.pws.calender.CompactCalendarView.FILL_LARGE_INDICATOR;
import static com.pws.calender.CompactCalendarView.NO_FILL_LARGE_INDICATOR;
import static com.pws.calender.CompactCalendarView.SMALL_INDICATOR;
...
class CompactCalendarController {
    ...
    private boolean shouldDrawIndicatorsSelectedDay = true;
    private boolean shouldDrawIndicatorsCurrentDay = true;
    ...
    private int weekDayBackgroundColor = Color.WHITE;
    ...
    private void loadAttributes(AttributeSet attrs, Context context) {
        if (attrs != null && context != null) {
            ...
            try {
                ...
                weekDayBackgroundColor = typedArray.getColor(R.styleable.CompactCalendarView_compactWeekDayBackgroundColor, weekDayBackgroundColor);
    ...
    public void shouldDrawIndicatorsCurrentDay(boolean shouldDrawIndicatorsCurrentDay) {
        this.shouldDrawIndicatorsCurrentDay = shouldDrawIndicatorsCurrentDay;
    }

    public void shouldDrawIndicatorsSelectedDay(boolean shouldDrawIndicatorsSelectedDay) {
        this.shouldDrawIndicatorsSelectedDay = shouldDrawIndicatorsSelectedDay;
    }
    ...
    void drawMonth(Canvas canvas, Calendar monthToDrawCalender, int offset) {
        ...
        for (int dayColumn = 0, dayRow = 0; dayColumn <= 6; dayRow++) {
            ...
            float top = dayRow * heightPerDay;
            float right = left + widthPerDay;
            float bottom = top + heightPerDay;
            ...
            if (dayRow == 0) {
                ...
                if (shouldDrawDaysHeader) {
                    ...
                    dayPaint.setStyle(Paint.Style.FILL);
                    // TODO
                    /*dayPaint.setColor(weekDayBackgroundColor);
                    canvas.drawRect(left, top, right, bottom, dayPaint);*/
                    dayPaint.setColor(calenderTextColor);
                ...
                if (shouldDrawIndicatorsSelectedDay && currentCalender.get(Calendar.DAY_OF_MONTH) == day && isSameMonthAsCurrentCalendar && !isAnimatingWithExpose) {
                ...
                } else if (shouldDrawIndicatorsCurrentDay && isSameYearAsToday && isSameMonthAsToday && todayDayOfMonth == day && !isAnimatingWithExpose) {
