...
public class CompactCalendarView extends View {
    ...
    public void setTypeFace(Typeface typeFace) {
        compactCalendarController.setTypeFace(typeFace);
    }
    ...
    public void shouldDrawIndicatorsCurrentDay(boolean shouldDrawIndicatorsCurrentDay) {
        compactCalendarController.shouldDrawIndicatorsCurrentDay(shouldDrawIndicatorsCurrentDay);
    }

    public void shouldDrawIndicatorsSelectedDay(boolean shouldDrawIndicatorsSelectedDay) {
        compactCalendarController.shouldDrawIndicatorsSelectedDay(shouldDrawIndicatorsSelectedDay);
    }
